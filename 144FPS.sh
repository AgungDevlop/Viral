#!/system/bin/sh
# 144FPS Module by Agung Developer
# Optimized for enforcing 144 FPS and disabling thermal limits
# Watermark: Agung Developer

# Display initial notification
cmd notification post -S bigtext -t 'FPS INJECTOR' 'Tag' 'Starting 144FPS Configuration by Agung Developer'

# Header with watermark
echo ""
echo "█▓▒▒░░░144FPS INJECTOR by Agung Developer░░░▒▒▓█"
echo ""
sleep 0.5
...
(
  ...
  setprop debug.mediatek_high_frame_rate_sf_set_big_core_fps_threshold 144
  ...
  settings put global tran_144hz_refresh_rate.not_support 1
  ...
  setprop debug.sf.high_fps_early_phase_offset_ns 1200000
  setprop debug.sf.high_fps_late_app_phase_offset_ns 300000
...
do
  ...
  echo "[✔] $app (144FPS) optimized by Agung Developer!"
done
...
echo "█▓▒▒░░░THANKS FOR USING 144FPS INJECTOR by Agung Developer░░░▒▒▓█"
echo ""

# Final notification
cmd notification post -S bigtext -t 'FPS INJECTOR' 'Tag' '144FPS SUCCESSFULLY ACTIVATED by Agung Developer'
