...
# Notification
cmd notification post -S bigtext -t 'BLACKSHARK 5 PRO' 'Tag' 'Activating BlackShark Fake Device' --icon "https://png.pngtree.com/recommend-works/png-clipart/20250321/ourmid/pngtree-green-check-mark-icon-png-image_15808519.png" > /dev/null 2>&1

echo ""
echo "█▓▒▒░░░FAKE DEVICE BLACKSHARK 5 PRO░░░▒▒▓█"
echo ""
sleep 0.5
...
setprop debug.sys.tran.device.name "BlackShark 5 Pro"
...
# CPU spoof for BlackShark 5 Pro
settings put global ro.board.platform sm8450
settings put global ro.vendor.soc.manufacturer Qualcomm
settings put global ro.vendor.soc.model Snapdragon_8_Gen_1
settings put global ro.soc.manufacturer Qualcomm
settings put global ro.soc.model Snapdragon_8_Gen_1

# Device spoof
setprop debug.sys.tran.device.name "BlackShark 5 Pro"
settings put system about_name "BlackShark 5 Pro"
settings put secure oppo_device_name "BlackShark 5 Pro"
settings put global vivo_device_name "BlackShark 5 Pro"
setprop persist.sys.tran.device.name "BlackShark 5 Pro"
setprop persist.sys.devicename "BlackShark 5 Pro"
setprop persist.sys.device_name "BlackShark 5 Pro"
settings put global ro.product.brand BlackShark
settings put global ro.product.vendor.manufacturer BlackShark
settings put global ro.product.odm.manufacturer BlackShark
settings put global ro.product.vendor.brand BlackShark
settings put global ro.product.manufacturer BlackShark
settings put global ro.product.model SHARK_KTUS-H0
settings put global ro.product.marketname "BlackShark 5 Pro"
settings put global ro.product.system.marketname "BlackShark 5 Pro"
settings put global ro.product.system.model SHARK_KTUS-H0
settings put global ro.product.vendor.model SHARK_KTUS-H0
settings put global ro.product.vendor.marketname "BlackShark 5 Pro"
settings put global ro.product.vendor.manufacturer BlackShark
settings put global ro.product.vendor.brand BlackShark
settings put global ro.product.odm.marketname "BlackShark 5 Pro"
settings put global ro.product.odm.model SHARK_KTUS-H0
settings put global ro.product.product.marketname "BlackShark 5 Pro"
settings put global ro.product.product.model SHARK_KTUS-H0
settings put global ro.build.product SHARK_KTUS-H0
settings put global ro.chipset Snapdragon_8_Gen_1

# Chipset spoof
settings put global ro.soc.manufacturer Qualcomm
settings put global ro.vendor.soc.manufacturer Qualcomm
settings put global ro.hardware.chipname Snapdragon_8_Gen_1
settings put global ro.chipname Snapdragon_8_Gen_1
settings put global ro.soc.model Snapdragon_8_Gen_1
settings put global ro.vendor.soc.model Snapdragon_8_Gen_1
settings put global ro.soc.model.external_name "Snapdragon 8 Gen 1"
settings put global ro.soc.model.part_name Snapdragon_8_Gen_1
settings put global ro.qti.soc_name Snapdragon_8_Gen_1
settings put global ro.qti.soc_model Snapdragon_8_Gen_1
settings put global ro.mtk.soc_name Snapdragon_8_Gen_1
settings put global ro.mtk.soc_model Snapdragon_8_Gen_1
settings put global ro.vendor.soc.model.external_name "Snapdragon 8 Gen 1"
settings put global ro.vendor.soc.model.part_name Snapdragon_8_Gen_1
settings put global ro.vendor.qti.soc_name Snapdragon_8_Gen_1
settings put global ro.vendor.qti.soc_model Snapdragon_8_Gen_1
settings put global ro.vendor.mtk.soc_name Snapdragon_8_Gen_1
settings put global ro.vendor.mtk.soc_model Snapdragon_8_Gen_1

# Additional spoof for phone info
settings put global device_name "BlackShark 5 Pro"
settings put system model "BlackShark 5 Pro"
settings put global ro.product.cpu.abi Qualcomm
settings put global ro.product.cpu.abilist "arm64-v8a,armeabi-v7a,armeabi"
settings put global ro.product.cpu.name "Snapdragon 8 Gen 1"
settings put global ro.product.vendor.cert "BlackShark 5 Pro"
settings put global ro.product.Aliases SHARK_KTUS-H0
settings put global ro.build.tf.modelnumber SHARK_KTUS-H0
settings put global ro.product.system_ext.brand BlackShark
settings put global ro.product.system_ext.device SHARK_KTUS-H0
settings put global ro.product.system_ext.manufacturer BlackShark
settings put global ro.product.system_ext.marketname "BlackShark 5 Pro"
...
cmd notification post -S bigtext -t 'BLACKSHARK 5 PRO' 'Tag' 'BlackShark 5 Pro Fake Device Activated' --icon "https://png.pngtree.com/recommend-works/png-clipart/20250321/ourmid/pngtree-green-check-mark-icon-png-image_15808519.png" > /dev/null 2>&1
