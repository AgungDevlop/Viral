...
(
    set_property debug.sf.frame_rate_multiple_threshold 240
    set_property debug.sf.log_expensive_rendering true
    set_property debug.sf.scroll_boost_refreshrate 240
    set_property debug.sf.touch_boost_refreshrate 240
